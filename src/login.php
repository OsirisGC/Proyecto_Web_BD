...
<body class="bg-gray-600">
    ...
    <div class="w-full flex justify-center h-auto">
        <div class="bg-gray-800 text-white w-2/12text-center flex flex-col gap-3 items-center p-5 rounded-xl py-16">
            ...
            <form action="" id="loginForm" class="flex flex-col gap-3  w-[300px]">
                <span>Email</span>
                <input type="email" name="email" id="email" class="border-2 bg-gray-800 border-gray-400 outline-none rounded-lg">
                <span>Password</span>
                <input type="password" name="password" id="password" class="border-2 bg-gray-800 border-gray-400 outline-none rounded-lg">
                <input type="submit" value="INGRESAR" class="border-3 text-white bg-blue-500 p-1 rounded-lg mt-3">
                <input id="btn" type="button" value="REGISTRAR" class="border-3 text-white bg-blue-500 p-1 rounded-lg mt-3">
            </form>
        </div>
    </div>

    <!-- NO ESCRIBIR CODIGO DEBAJO DE ESTO -->
    <?php include_once($_SERVER['DOCUMENT_ROOT'] . '/proyecto/components/templates/footer.php'); ?>
    <!-- NO ESCRIBIR CODIGO DEBAJO DE ESTO -->
</body>
